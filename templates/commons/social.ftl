...
<li><a rel="me" href="https://${config.sidebar_social_mastodon_domain}/${config.sidebar_social_mastodon}" target="_blank" title="Mastodon"><i class="bi bi-mastodon"></i></a></li>
</#if>
